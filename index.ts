...
import { BotFrameworkExporter, FileWriter, Kind, ProjectReference } from "@botmock/export";
...
async function main(): Promise<void> {
  ...
  const exporter = new BotFrameworkExporter({ token: process.env.BOTMOCK_TOKEN as string });
